...
df.to_csv("/Users/khalednakhleh/Documents/ecen_689/ECEN689-Fall2018" \
          "/Challenges/1Files/1challenge1activity_khaled.jamal.csv")

# Final file can be found in challenges/1Files folder on GitHub.
# File name is 1challenge1activity_khaled.jamal.csv
